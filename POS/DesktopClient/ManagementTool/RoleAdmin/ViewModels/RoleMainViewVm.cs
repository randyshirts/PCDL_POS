...
{
	public class RoleMainViewVm : ViewModel 
	{
        public RoleMainViewVm()
		{
            InitializeChildViews();

            //Register for messages
            Messenger.Default.Register<SwitchView>(this, RoleAdminVm.Token, msg => ViewSelector(msg.ViewModel));
        ...
        private void LoadAddNewMainView(ViewModel newViewModel)
        {
            ...
            if (newViewModel.GetType() == (typeof(RoleAdminVm)))
            {
                TopLeftColSpan = "1";
                TopLeftRowSpan = "1";
            }
        ...
        public ActionCommand RoleAdminButtonCommand
        {
            get
            {
                var myAddItemVm = new RoleAdminVm();
