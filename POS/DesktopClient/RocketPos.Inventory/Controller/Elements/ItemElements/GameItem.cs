...
{
    public class GameItem : ObservableObjects, IItemElement 
    {
        public GameItem()
        { }
            ...
            set
            {
                ...
                else
                {
                    if (WpfHelpers.UpdateStatus(value, _itemStatus))
                    {
                        ...
                        controller.UpdateItem(ConvertGameItemToItem());
                    }
        ...
        public Game ConvertGameItemToGame()
        {
        ...
        public Item ConvertGameItemToItem()
        {
