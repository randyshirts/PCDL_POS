...
{
    public class ConsignorItem : ObservableObjects
    {
        public ConsignorItem()
        { }

        public ConsignorItem(Item item)
        {
            ...
            set
            {
                ...
                else
                {
                    if (WpfHelpers.UpdateStatus(value, _itemStatus))
                    {
                        ...
                        controller.UpdateItem(ConvertConsignorItemToItem());
                    }
        ...
        public Item ConvertConsignorItemToItem()
        {
