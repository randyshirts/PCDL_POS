                ...
                c => new
                    {
                        ...
                        BookImage = c.String(maxLength: 200, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        GameImage = c.String(maxLength: 300, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        Manufacturer = c.String(maxLength: 100, storeType: "nvarchar"),
                        EAN = c.String(maxLength: 13, storeType: "nvarchar"),
                        OtherImage = c.String(maxLength: 300, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        Manufacturer = c.String(maxLength: 100, storeType: "nvarchar"),
                        EAN = c.String(maxLength: 13, storeType: "nvarchar"),
                        TeachingAideImage = c.String(maxLength: 300, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        VideoImage = c.String(maxLength: 300, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.Id);
