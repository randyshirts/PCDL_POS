    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> UpdatePerson(UserInfoOutput input)
        {
            ...
            using (var repo = new PersonRepository())
            {
                ...
                {
                    if ((input.MailingAddress != null) && (input.City != null) && (input.State != null) &&
                        (input.ZipCode != null))
                    {
                    ...
                    {
                        if ((input.MailingAddress != null) || (input.City != null) || (input.State != null) || (input.ZipCode != null))
                            return Ok("Incomplete Address Input");
                    }
                }
