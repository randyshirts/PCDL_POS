...
namespace PcdWeb.Providers
{
    public class SimpleAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        //    //Todo: Client - what is it in new Identity Model?
        //    client = _userAppService.FindClient(context.ClientId);
        ...
        //    IdentityUser user = await _userAppService.FindUser(context.UserName, context.Password);
