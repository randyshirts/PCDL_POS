define(['plugins/router', 'durandal/app', 'global/session', 'services/security', 'services/logger', 'jquery', 'plugins/history'],
    function (router, app, session, security, logger, $, history) {
        ...
        function init() {
            //var active = router.activeInstruction();
            var dfd = $.Deferred(), fragment = history.getFragment(fragment, false), externalAccessToken, externalError, loginUrl;
            //var dfd = $.Deferred(), fragment = active.fragment, externalAccessToken, externalError, loginUrl;
